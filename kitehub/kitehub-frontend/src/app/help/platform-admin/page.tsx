...
const PERSONA = 'platform-admin';
const PERSONA_LABEL = 'Platform Admin';

export const metadata: Metadata = {
  title: `Hướng dẫn KiteHub — ${PERSONA_LABEL}`,
  description:
    'Tài liệu hướng dẫn KiteHub dành cho Platform Admin: bảng giá + thanh toán, mời nhân viên, tuỳ chỉnh logo, cấu hình chung.',
  alternates: { canonical: `${SITE_URL}/help/${PERSONA}` },
};

export default function PlatformAdminManualIndexPage() {
    ...
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-base text-slate-700">
          Bạn là Platform Admin? 5 trang dưới đây giúp bạn nắm vững các tác vụ chính:
          duyệt beta, impersonation, monitoring, quản lý tenant.
        </p>
      </header>
