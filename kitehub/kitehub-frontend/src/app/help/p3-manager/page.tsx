...
export const metadata: Metadata = {
  ...
  description:
    'Tài liệu hướng dẫn KiteHub dành cho Quản lý trung tâm: bảng giá + thanh toán, mời nhân viên, tuỳ chỉnh logo, cấu hình chung.',
  alternates: { canonical: `${SITE_URL}/help/${PERSONA}` },
};

export default function P3ManagerManualIndexPage() {
    ...
    <main className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-base text-slate-700">
          Bạn là Quản lý trung tâm? 5 trang dưới đây giúp bạn nắm vững các tác vụ chính:
          vận hành hàng ngày, báo cáo, quyền hạn STAFF, quy trình accept invite.
        </p>
      </header>
