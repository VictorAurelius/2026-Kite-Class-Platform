 ...
 *
 * Source spec: kitehub-pro-v2/screens/dashboard-default.html (header search
 * button labeled "Tìm nhanh" with ⌘K hint).
 *
 * Features:
 ...
 *     invokes `onSelect`.
 *
 * Mirror of Wave 30 KC primitive — uses `next/navigation` router which is
 * Next.js framework, not app-specific.
 *
