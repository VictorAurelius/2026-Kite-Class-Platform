 ...
 *      providers/NextThemesProvider).
 *   3. Exposes `useDashboardTheme()` hook with typed `mode` + `toggle()`.
 *
 * Root layout already mounts NextThemesProvider; this component simply
 * exports the typed hook + a small client-only `<DashboardThemeToggle>`
 * button for the dashboard chrome.
 */
...
const STORAGE_KEY = 'kiteclass.dashboard.theme';
