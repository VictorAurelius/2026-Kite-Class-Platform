...
export const ORGANIZATION_TEMPLATE: TemplateConfig = {
  ...
  sections: [
    { id: 'hero', label: 'Giới thiệu chính', enabled: true, order: 0 },
    { id: 'about', label: 'Giới thiệu', enabled: true, order: 1 },
    { id: 'courses', label: 'Khóa học', enabled: true, order: 2 },
    { id: 'teachers', label: 'Đội ngũ giáo viên', enabled: true, order: 3 },
    { id: 'certificates', label: 'Chứng chỉ', enabled: true, order: 4 },
    { id: 'gallery', label: 'Thư viện ảnh', enabled: false, order: 5 },
    { id: 'news', label: 'Tin tức', enabled: false, order: 6 },
    { id: 'enrollment', label: 'Tuyển sinh', enabled: true, order: 7 },
    { id: 'pricing', label: 'Bảng giá', enabled: true, order: 8 },
    { id: 'testimonials', label: 'Đánh giá', enabled: true, order: 9 },
    { id: 'faq', label: 'Câu hỏi thường gặp', enabled: true, order: 10 },
    { id: 'parents', label: 'Phụ huynh', enabled: false, order: 11 },
