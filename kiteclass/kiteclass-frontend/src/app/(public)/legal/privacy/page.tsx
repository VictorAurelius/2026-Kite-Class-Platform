...
export const metadata: Metadata = {
  title: 'Chính sách quyền riêng tư | KiteClass',
  description:
    'Chính sách quyền riêng tư áp dụng cho dịch vụ KiteClass theo Nghị định 13/2023/NĐ-CP (PDPL) — bảo vệ dữ liệu cá nhân của giáo viên, học sinh, phụ huynh và staff trung tâm.',
};
