...
/**
 * DSAR (Data Subject Access Request) self-service intake form — KiteClass.
 *
 * Phase 2 v1 (Wave 26 Bucket A, GAP-353c) — Vietnamese-first, EN deferred to GAP-182 Phase 2.
 *
 * Per BR-PDPL-DSAR-001..005 in `documents/01-business/kitehub/marketing/rules.md` (cross-product canonical):
 ...
 * - Honeypot field (`companyWebsite`) — kept hidden; bots blindly populate.
 *
 * Posts to `/api/v1/dsar/request` (proxied via gateway to kitehub-subscription).
 */
    ...
    <form onSubmit={handleSubmit} className="space-y-6" noValidate>
      ...
      <label className="flex flex-col gap-1 text-sm">
        ...
        <textarea
          ...
          maxLength={4000}
          rows={3}
          placeholder="VD: Hồ sơ học viên, lịch sử học, thanh toán, tin nhắn..."
          className="rounded-md border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary"
        />
      </label>
