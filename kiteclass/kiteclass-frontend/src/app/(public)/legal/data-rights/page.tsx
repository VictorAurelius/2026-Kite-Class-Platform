...
/**
 * DSAR self-service intake page — KiteClass.
 *
 ...
 * (cross-product canonical — KC inherits PDPL rules from KH marketing domain).
 * 6 PDPL Art 14 rights + 20-day SLA (Decree 13/2023 Art 19).
 */
export const metadata: Metadata = {
  title: 'Yêu cầu quyền dữ liệu cá nhân (DSAR) | KiteClass',
  description:
