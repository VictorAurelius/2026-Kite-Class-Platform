...
export const metadata: Metadata = {
  title: 'Chính sách Cookie | KiteClass',
  description:
    'Chính sách Cookie của KiteClass — phân loại cookie (essential / analytics / marketing), retention period, LocalStorage usage, và quy trình rút lại đồng ý theo Nghị định 13/2023/NĐ-CP.',
};
    ...
    <main className="container max-w-4xl py-12">
      <article className="space-y-6 text-sm leading-relaxed">
        ...
        <section>
          ...
          <p>
            <strong>Phase 1:</strong> KiteClass KHÔNG sử dụng marketing cookies.
