/**
 * Parent-invite redemption form — lazy-loaded body of
 * `/parent-invite/[token]` page.
 *
 * Reads the route param via `useParams`; the page wrapper renders only
 * the layout + skeleton until this chunk hydrates.
 *
