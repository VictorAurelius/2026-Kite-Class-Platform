...
public class PaymentWebhookController {
     ...
     *
     * @param params webhook parameters from MoMo
     ...
     *
     * @param params webhook parameters from ZaloPay
     * @return JSON response with return_code (1=success, 0=error)
     */
    @PostMapping("/zalopay")
    public ResponseEntity<Map<String, Integer>> zalopayCallback(@RequestBody Map<String, String> params) {
        log.info("Received ZaloPay webhook callback");
        log.debug("ZaloPay params: {}", params);
