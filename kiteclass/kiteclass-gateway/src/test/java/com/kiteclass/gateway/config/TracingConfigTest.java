...
/**
 * GAP-112 — Distributed tracing wiring smoke test for kiteclass-gateway.
 *
 * <p>Gateway is the trace-injection edge — Micrometer-Tracing instruments
 * Spring Cloud Gateway routes and propagates {@code traceparent} headers
