...
| `kitehub-story-v2/` (Direction A polish) | 3 | 🟡 ACTIVE 2026-05-05 — Wave 21 single-bucket; agent building from Round 1 baseline (archived JSX 546 LOC → HTML kit per Round 2/3 standard); promoted from P2 LOWER per user request — [GAP-350](../../../04-quality/gaps/GAP-350-round-3-polish-kitehub-story-v2.md) (P2) | — pending agent ship | — |
