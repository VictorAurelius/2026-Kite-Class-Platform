...
| **A.14 System Acquisition + Maintenance** | 🟡 | Secure SDLC; dep scanning; secret scanning | Trivy SARIF on every PR (per `core-ci.yml`); CodeQL planned Phase 2; npm-audit + dependabot weekly | Trivy gate `trivy-sarif-guard.sh` ships Wave 91; npm-audit baseline | ✅ DONE Phase 1 BETA scope |
