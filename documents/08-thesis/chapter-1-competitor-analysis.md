...
Các tham khảo chính của đề tài bao gồm: các văn bản pháp luật Việt Nam (PDPL 2023 [9], Luật An ninh mạng 2018 [10], Nghị định 13/2023/NĐ-CP [19], Nghị định 53/2022/NĐ-CP [11], Thông tư 78/2021/TT-BTC [21], Thông tư 29/2024/TT-BGDĐT [1]); các báo cáo thị trường edu Việt Nam (Magenest 2024 [2], 6Wresearch [3], VECITA Kinh tế Số 2024 [4]); các nghiên cứu nền tảng về AI sinh ảnh (Stable Diffusion XL [13], GPT-3 few-shot [12], LLaVA visual instruction [14]); các phương pháp luận phần mềm cổ điển (Deming PDCA [22], Beck TDD [17], Poppendieck Lean [23], IEEE 730-2014 SQA [24], OWASP Top 10 [20]); và tài liệu kỹ thuật của các sản phẩm tham khảo (MISA AMIS [5], Mona eLMS [6], Easy Edu [7], DotB [8]).
