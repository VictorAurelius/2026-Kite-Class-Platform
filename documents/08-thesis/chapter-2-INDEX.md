...
| 2.5 | Mermaid `classDiagram` | line 498 | ⚠️ thiếu bold caption, body đã cite `Hình 2.5`; đề xuất `**Hình 2.5: Class diagram: Core Domain entity giáo dục multi-tenant**` | §2.3.1 Class Diagram |
...
|:-:|--------------|---------|--------|
| không có | (chưa có bảng được đánh số `**Bảng 2.M**` chính thức) | không có |, |
...
- [ ] Thêm caption `**Hình 2.5: Class diagram: Core Domain entity giáo dục multi-tenant**` sau Mermaid line ~498
