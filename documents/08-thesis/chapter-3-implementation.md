...
**Hình 3.1.** Luồng khám phá và kích hoạt tenant qua bốn bước nối tiếp từ trang chủ marketing đến dashboard sau đăng nhập đầu tiên.
...
**Hình 3.2.** Luồng vận hành nghiệp vụ thường nhật gồm giao diện quản lý lớp học và giao diện tạo hóa đơn với định dạng VND.
*Nguồn: ảnh chụp giao diện KiteHub Platform, truy cập 20/05/2026*
...
**Hình 3.3.** Luồng điều hành Admin nền tảng với preview template email và trang audit log immutable tuân thủ PDPL Article 11.
*Nguồn: ảnh chụp giao diện KiteHub Platform, truy cập 20/05/2026*
