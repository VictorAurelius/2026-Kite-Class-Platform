---
title: Defense Q&A Response Sheet — câu hỏi chuẩn bị theo 4 archetype người chấm
chapter: defense
audience: thesis
status: ready
created: 2026-05-23
...
# Defense Q&A Response Sheet — câu hỏi chuẩn bị

**Mục tiêu:** chuẩn bị câu trả lời cô đọng (≤120 từ mỗi câu) cho 26 câu hỏi dự kiến từ hội đồng, phân nhóm theo 4 archetype người chấm. Mỗi câu trả lời cite evidence cụ thể (file path, audit report, chapter section, migration version) để chứng minh có cơ sở.
...
Baseline security gần nhất em trích trong báo cáo là 93/100 A (audit v2, 27/27 evidence block per-control). 7 điểm thiếu gồm: (i) **2 P1 carry-forward:** TOTP secret chưa lưu KMS (đang mã hóa app-level — accepted risk hiện tại); một endpoint admin cấu hình chưa chặt; (ii) **3 P2:** rate-limit per-endpoint granular, CSP strict-dynamic, Permissions-Policy header. Mỗi mục có disposition rõ ràng (accepted risk hoặc backlog có deadline). Audit là continuous loop, các đợt mở rộng phạm vi sau có thể phát sinh mục mới, đều được track qua gap và ưu tiên đóng theo lộ trình. OWASP Top 10 mapping ở Chương 2 §2.1.2 Bảng 2.3.
...
## Archetype 3 — Defense committee Business/Product/Compliance
...
Em xin nói rõ phạm vi: đồ án vận hành thử minh chứng với các giảng viên đại diện (giả định minh họa) thay vì một cohort khách hàng đã ký hợp đồng. Chương 4 §4.2 trình bày hai gói qua hai giảng viên độc lập: cô Nguyễn Thị Hà (gói Miễn phí, bộ nhận diện dựng từ mẫu) và thầy Nguyễn Đình Nhì (gói Trả phí, bộ nhận diện sinh tự động qua AI Branding), cùng tenant landing mẫu cô Đỗ Lan Khánh. Mục đích là chứng minh cùng một nền tảng multi-tenant phục vụ cả quy mô nhỏ lẫn nhu cầu nâng cao. **Limitation thừa nhận:** việc thu thập phản hồi và xác nhận từ người dùng thật quy mô lớn thuộc lộ trình phát triển sau, chưa hoàn tất trong khung thời gian đồ án.
