...
- **2026-05-11:** Plan drafted. Triggered by post-pending-legal scope cut (PR #1165) — pre-cutover queue cleared except P0 hardening items. Spawning deferred to next session for fresh context budget.
