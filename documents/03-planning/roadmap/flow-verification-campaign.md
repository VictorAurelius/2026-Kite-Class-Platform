...
| KC-3 | Academic: year→course→class→schedule | 6 | ⬜ (plan stub ready) | [wave-2026-06-05-flow-kc3](../waves/wave-2026-06-05-flow-kc3-academic-year-course-class-schedule.md) | GAP-909 P2 (course drift); ⚠️ class/schedule controller chưa thấy — partial-impl risk (verify at session start) |
