...
**Status:** 🔴 P0 BLOCKING — supersedes GAP-458 (`kitehub.me` as customer domain decision 2026-05-09); reframes GAP-459 (`.vn` → `.me` sweep); blocks AWS Activate $1k credit resubmit
**Priority:** 🔴 P0 (Phase 1 BETA launch blocker; brand-clearance affects every customer-facing surface + trademark filing + AWS Activate context)
