...
- [ ] `GET :9000/api/v1/admin/payroll/periods` (ADMIN) → 200 (không 404)
- [ ] `/configs` + `/periods/{id}` reachable qua gateway
- [ ] kitehub-admin KH-9 endpoints vẫn route đúng (no regression)
- [ ] Payroll cross-tenant verified scoped sau routing fix (GAP-1039 sweep)
