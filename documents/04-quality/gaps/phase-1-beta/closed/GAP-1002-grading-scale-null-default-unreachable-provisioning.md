...
## Acceptance Criteria
- [x] New tenant tự có 8 default grading scales (provisioning hook) HOẶC reference-data refactor
- [x] calculate/finalize works cho tenant mới không cần manual seed
...
🟢 DONE — engineering-complete + G3 production-parity walk verified. Bucket E — DefaultGradingScaleProvisioner seeds 8 bands per-tenant trong TenantProvisioningSaga (idempotent).
