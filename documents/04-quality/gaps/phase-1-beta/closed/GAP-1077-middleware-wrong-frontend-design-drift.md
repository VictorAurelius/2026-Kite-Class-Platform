...
- [x] Walk production-accurate qua kiteclass-frontend (nip.io subdomain) → landing render đúng tenant branding — **G2★ human walk PASS 2026-06-12** (recipe `2026-06-11-g2-recipe-landing-100-nipio-subdomain.md`: 3 tenant theme riêng + empty-state + mobile + sad-path SUSPENDED/unknown-subdomain).

## Log

- 2026-06-12 — **DONE.** AC cuối (nip.io production-accurate walk) PASS bởi human G2★ landing-100 2026-06-12: cô Hà (xanh dương) / thầy Nhì (xanh lá) / Sky (cam) render đúng per-tenant qua Host-resolution thật; sad-path S1 SUSPENDED + S2 unknown-subdomain đúng expected. Stack rebuild main `e21c0960d` (kèm GAP-1235 chân dung + carousel). Campaign gate G2★-absorbs-G3-functional lần đầu chạy trọn — validate gate model 2026-06-11.
