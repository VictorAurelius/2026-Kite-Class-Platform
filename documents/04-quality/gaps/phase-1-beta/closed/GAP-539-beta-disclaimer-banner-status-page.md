...
- **2026-05-18 (PR #1551 merged)** — Wave 98 Bucket B3 finishing stroke shipped — dashboard mount + version chip env-driven + PDPL consent BVDLCN 2023 Điều 9-15 + /beta-status freshness signal Linear-style. Status PARTIAL 90 → DONE 100. Sync per `post-merge-sync-completeness.md` §4. File git-mv'd to closed/ per `gap-folder-organization.md` v2.0.0 §3.3.
