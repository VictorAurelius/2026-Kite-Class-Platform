...
- **2026-06-12 (v2 refinement — user-flagged 4 điểm):** (1) slide = ẢNH thuần, bỏ text overlay (banner tự chứa nội dung thiết kế); (2) carousel đa-banner per GV — Hà 4 / Nhì 4 / Khánh 3 (toàn bộ banner trong 08-thesis/portrait, webp 1200w); (3) hero copy (eyebrow/h1/sub) switch theo GV qua BRAND map (trước chỉ cô Hà); (4) chân dung "ảnh gốc" chất lượng cao 800w — Hà=banner-quyet-tam-2 (user example), Nhì=banner-quyet-tam, Khánh=portrait-goc. Bonus sweep: label "Cô Khánh · Anh/IELTS" → "GDCD/Pháp luật" (khớp demo-trio thật Đỗ Lan Khánh + banner pháp luật) ở landing-personal + about.html. JS carousel rebuild-per-theme, node --check PASS.
