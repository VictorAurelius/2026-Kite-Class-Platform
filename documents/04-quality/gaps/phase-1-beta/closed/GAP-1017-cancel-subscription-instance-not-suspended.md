...
- [x] Cancel immediate → instance chuyển SUSPENDED
- [x] Cancel end-of-cycle → instance SUSPENDED khi tới expiry (scheduler)
- [x] IT verify instance status thay đổi đúng theo immediate flag
...
🟢 DONE — engineering-complete + G3 production-parity walk verified. G3 walk #7 — cancel immediate suspend instance + sub CANCELLED; scheduler suspend cancelled-expired.
