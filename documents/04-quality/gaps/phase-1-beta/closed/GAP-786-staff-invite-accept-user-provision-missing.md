...
- **2026-05-28** (PR #1929 MERGED to main per `feedback_post_merge_doc_sync.md`) — Wave A Bucket B code shipped to main HEAD via squash. Post-merge audit follow-up tracked GAP-789 (business-logic + api-contract audit suite refresh + 01-business doc update, 3-day deadline 2026-05-31 per `post-wave-audit-mandate.md` §2.2). 1 SKIPPED CI check (release-tag-only path); 43/44 PASS gate confirmed pre-merge.
