...
- **2026-05-18 (PR #1555 merged)** — Wave 98 Bucket B5 — Status flip 🟡 PARTIAL 80 → 🟢 DONE 100. FeedbackForm Radix Dialog wired into SupportMenu (replaces standalone floating widget per outside-in audit F-NEW-2 collision finding). Sync per `post-merge-sync-completeness.md` §4. File git-mv'd to closed/ per `gap-folder-organization.md` v2.0.0 §3.3.
