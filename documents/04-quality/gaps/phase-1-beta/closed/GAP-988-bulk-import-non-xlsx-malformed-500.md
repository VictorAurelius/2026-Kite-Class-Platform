...
## Acceptance Criteria
- [x] Upload CSV/ảnh/file rỗng → 400/415 (not 500)
- [x] Upload oversized → 413
- [x] Upload XLSX hợp lệ → 200 preview
- [x] IT cover non-XLSX → 4xx
...
- **2026-06-05 (Wave flow-kc4 — DONE):** assertXlsxType + parseSafely RuntimeException catch + MaxUploadSize handler; IT 10/10 + G1 live csv->415 fake.xlsx->400.
