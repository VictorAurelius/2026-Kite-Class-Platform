...
- [ ] State machine full PENDING→VERIFIED→CERT_PROVISIONING→ACTIVE
- [ ] Timeout job set FAILED sau N giờ no-TXT
- [ ] ACTIVE domain thực sự route tới instance (gateway + cert)
- [ ] IT cover state transitions (mock DNS verified)
