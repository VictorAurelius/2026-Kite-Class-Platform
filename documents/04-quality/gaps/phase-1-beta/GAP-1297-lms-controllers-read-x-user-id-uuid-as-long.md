...
G1-FE confirm: fix X-User-Reference-Id hoạt động qua browser — authenticated LMS GET (`/courses/1` content-tab, `/student/learning`, `enrollments/me`) đều 200 (không còn 400). studentId=4/164 resolve đúng từ gateway-injected header. — verified qua Playwright headless trên FE thật `skytest.127.0.0.1.nip.io:3000` (rebuild kiteclass-frontend). Evidence: `documents/04-quality/audits/rst-html/2026-06-14-g1-fe-browser-walk.md`. **Giữ PARTIAL** — human G2★ vẫn bắt buộc (mutation deep-interaction chưa walk).
