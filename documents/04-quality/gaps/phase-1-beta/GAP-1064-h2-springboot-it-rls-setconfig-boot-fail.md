...
- [ ] Audit: liệt kê mọi H2 `@SpringBootTest` IT fail set_config boot (grep + run)
- [ ] Mỗi IT: migrate Testcontainers HOẶC document tại sao H2 đủ
- [ ] CI gate: H2 boot-fail không còn ẩn dưới dạng "passed"
