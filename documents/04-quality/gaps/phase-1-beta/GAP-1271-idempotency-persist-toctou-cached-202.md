...
- [ ] Concurrent same-key request: loser nhận cached 202, không phải 500
- [ ] Transaction không bị poison khi UNIQUE violation
- [ ] Test idempotency race xác nhận hành vi
