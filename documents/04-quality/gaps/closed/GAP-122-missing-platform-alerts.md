...
- [x] `documents/05-guides/monitoring/alerting-standards.md` (192 lines, severity rules + runbook contract + metric-pending pattern + ownership matrix)
