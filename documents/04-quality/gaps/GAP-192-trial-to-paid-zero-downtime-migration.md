...
**Status:** 🟡 PARTIAL (Phase 3 design docs 2026-04-20; Phase 4a backend state machine + outbox + endpoints 2026-04-21; Phase 4b async worker + webhook HMAC + idempotency + FE deferred)
