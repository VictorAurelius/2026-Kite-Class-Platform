# GAP-1134: AI Branding wizard thiếu bước upload chân dung (asset chính của banner; count theo user-type)
...
Số lượng chân dung phụ thuộc **user-type** ([[GAP-1133]]): GV đơn lẻ = 1 người, trung tâm = nhiều người. Wizard chưa có cả input user-type lẫn bước upload chân dung → banner-compose ([[GAP-1135]]) thiếu asset đầu vào.

## Proposed Fix

1. Thêm **Portrait upload step** (sau Audience / user-type, trước/ghép Template) — upload 1..N ảnh chân dung; count tối đa gợi ý theo user-type ([[GAP-1133]]).
...
3. Portrait assets feed sang banner-compose ([[GAP-1135]]) làm lớp giữa.
...
- [ ] Portrait feed sang banner render ([[GAP-1135]])
...
- Depends: [[GAP-1133]] (user-type quyết count)
- Feeds: [[GAP-1135]] (banner compose dùng portrait)
