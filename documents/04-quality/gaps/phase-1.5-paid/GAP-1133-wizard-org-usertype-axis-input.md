# GAP-1133: AI Branding wizard thiếu trục user-type (GV đơn lẻ / trung tâm) — input độc lập với audience
...
- **Chiến lược asset**: số chân dung upload (đơn lẻ = 1 người, trung tâm = nhiều người) → xem [[GAP-1134]]
...
3. Dùng user-type làm input cho: portrait count ([[GAP-1134]]) + tier-hint gợi ý nâng cấp.
...
- [ ] User-type feed sang portrait step ([[GAP-1134]]) quyết count
- [ ] Build + test xanh

## Related

- Discovered in: discuss wizard 6-bước 2026-06-10 (user design critique câu 1)
- Cluster wizard-redesign: [[GAP-1134]] (portrait) + [[GAP-1135]] (banner render + AI keys) + [[GAP-1136]] (full-screen preview)
