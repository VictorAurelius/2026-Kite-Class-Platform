...
| 7 | **Meta Phase-2 Cleanup cluster** | GAP-193 P2 (P1 — session-lock hook) + GAP-194 P2 (P1 — lefthook pre-commit) + GAP-195 P2a (P2 — starter-kit triage; 2b → GAP-262 deferred) | P1+P2 | 🟡 IN_PROGRESS 2026-04-29 — foundation PR live; agents spawn after merge. Plan: `documents/03-planning/waves/wave-2026-04-29-meta-phase2-cleanup.md` |
