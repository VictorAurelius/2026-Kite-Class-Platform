...
2. **GAP-222a SHIPPED 2026-04-26** ✅ → next: **GAP-230** (Meta-P1, rule §3.5.1 Exception D for dispatcher infra) + **GAP-222b** (Meta-P1, ParentInvitationServiceImpl) + **GAP-222c** (kitehub-subscription EmailServiceClient + InstancePurgeService — re-triage after GAP-230 lands)
