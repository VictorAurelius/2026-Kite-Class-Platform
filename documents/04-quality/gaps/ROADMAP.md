...
2. **GAP-222a + GAP-230 SHIPPED 2026-04-26** ✅ → next: **GAP-222b** (Meta-P1, ParentInvitationServiceImpl in kiteclass-core) + **GAP-222c** (Meta-P1, M effort — re-scoped to 2 sites: EmailServiceClient + InstancePurgeService Exception A migration in kitehub-subscription)
