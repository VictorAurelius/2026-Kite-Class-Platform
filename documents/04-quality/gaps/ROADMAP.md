...
- **2026-06-11 landing-100 fix-pack (PR #2326 OPEN):** 25 gaps xử lý (19+ DONE) + 2 kit mới (landing-personal 113/128, kiteclass-public 4×110-115) + multi-banner V96 + port 4 trang public + META wave-closure v1.2.0 (fix-hết-không-kể-phase). Re-score 81→~89-90/100. Còn: human G2★ + GAP-1221/1222 decision → flip complete. branding-100 plan draft (3 audit; GAP-1213 P0 deploy=MOCK).
