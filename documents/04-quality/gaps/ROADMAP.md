...
| **Track 2 Phase 4 kit ports** | 🟡 **2 of 7 SHIPPED** (Waves 30-31) | KC pro v2 ✅ DONE (Wave 30); KH pro v2 ✅ DONE (Wave 31, GAP-270 PARTIAL — backend endpoint follow-ups GAP-270b/c/d); ai-branding-wizard (GAP-272) Wave 32 ready (plan #878 — Direction C 6-step refactor of legacy 4-step wizard, 13 new app-local primitives, 6+ backend endpoint state-checks deferred to agent runtime); teacher (GAP-268) tier P3; K-12 trio (GAP-267/269/271) deferred Phase 3 per CLAUDE.md decision-context |
...
- 🟡 2 of 7 Track 2 kit ports shipped (Waves 30-31); ~5 kits remaining (with K-12 trio deferred Phase 3 — effective ~2 critical: ai-branding-wizard Wave 32 + teacher GAP-268 P3)
