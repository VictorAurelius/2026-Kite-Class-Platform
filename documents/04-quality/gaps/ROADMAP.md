...
| 6 | **Meta-Gov 2 cluster** (next) | GAP-245 (P1 — Maven `-Xlint`/`-Werror` profile) + GAP-225 (P1 — scaffold-as-DONE truth-up) + GAP-224 (P3 — collect-state regex) + housekeeping status-sync GAP-202/206/207 | P1+P3 | 🟡 IN_PROGRESS 2026-04-29 — foundation PR live (this PR); agents spawn after merge. Plan: `documents/03-planning/waves/wave-2026-04-29-meta-gov-2.md` |
