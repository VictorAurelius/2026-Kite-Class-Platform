...
**Status:** 🟡 PARTIAL 2026-05-08 — kh_backend right-size ✅ DONE (in-place modify); kc_app replaced unintentionally + drift tracked GAP-450; CWAgent install pending manual SSM step; kc_app_memory alarm deferred Phase 7
