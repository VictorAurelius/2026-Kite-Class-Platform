...
- **Compromised tenant API key** → key leaked in their public repo, scraper using it. **Fix:** rotate the tenant's API key, notify their admin contact, document the incident in `documents/05-guides/SECRET-MANAGEMENT.md`.
