...
| 5 | Footer | **⚠️ 5/10** | Có `support@kiteclass.com` (default). Thiếu `/beta-status` link (GAP-539 sync). Thiếu mention `support@kitehub.me` (GAP-540 sync). Copyright OK. |
...
3. **Footer add support@kitehub.me** (sync GAP-540): switch default email từ `support@kiteclass.com` → `support@kitehub.me`.
