...
- **Compliance check:** **Considered (self-assessed, counsel pending GAP-156 AC-D)** — per `documents/00-brd/compliance-checklist.md` L2/L3/L7: **Luật Bảo vệ Quyền lợi Người tiêu dùng 2023** (Luật 19/2023/QH15 — price transparency per tier, refund/cancel/auto-renew disclosure SUB-03/12/13, dispute window); **Nghị định 123/2020/NĐ-CP** (e-invoice on subscription payment confirm SUB-19); **Luật Giao dịch điện tử 2023** (electronic billing contract, accept-ToS = giao kết); plus **Luật Quản lý Thuế 2019** (billing record retention). ⚠️ Auto-renew default `true` (SUB-03) + manual VietQR capture (SUB-11/19) — clear pre-charge disclosure required per Consumer Protection Law; e-invoice provider integration deferred GAP-185 Phase 1.5+. No counsel verification yet.
