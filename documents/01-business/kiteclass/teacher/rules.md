...
- **Compliance check:** **Compliant** — Bộ luật Lao động 2019 (teacher contract terms); Luật Giáo dục 2019 (teacher qualification requirements).
- **Review cadence:** Quarterly (default per `business-logic-review.md` §2.5). **Next review:** 2026-08-08. Event triggers: Labor law amendment, MoET teacher-qualification standard update.
