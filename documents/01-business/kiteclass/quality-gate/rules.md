...
- **Compliance check:** **N/A** — internal automated quality threshold; no PII, no advertised SLA tied.
- **Review cadence:** Quarterly (default per `business-logic-review.md` §2.5). **Next review:** 2026-08-08. Event triggers: GAP-226/227/228 real measurement landing, threshold tier-specific override.
