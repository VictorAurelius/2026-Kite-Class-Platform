...
- **Compliance check:** **N/A for Phase 1** — Phase 1 calculates GROSS only with deductions=0; no tax / social-insurance number is computed. Phase 2 (GAP-057b) **MUST be Compliant** with: Luật Quản lý Thuế 2019 (TNCN withholding), BHXH 8% + BHYT 1.5% (Luật BHXH 2014 — current rates, may shift before Phase 2 ships), Luật Lao động 2019 (teacher contracts).
