...
- 4 agents spawned in single message with `run_in_background: true` (Agent A kiteclass-student / Agent B kitehub-admin / Agent C components batch 1 / Agent D components batch 2)
