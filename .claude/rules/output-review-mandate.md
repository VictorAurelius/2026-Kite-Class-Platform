...
| **Ops readiness** | ops-readiness-audit skill /100 | Post-wave + quarterly | Auditor | ✅ REFRESHED (2026-05-15, **78/100 C+** — Wave 84 post-apply Bucket H; +18 vs Wave 40 baseline 60; CloudTrail observability (GAP-437 DONE) + startupProbe (GAP-431 DONE) + secrets rotation 90d (GAP-379 95%) + EC2 cost monitoring (GAP-414 DONE) + 4 NEW account-prep runbooks (GAP-394/423/424 DONE); 1 P0 GAP-257 restore drill + 1 P1 GAP-144 receivers chặn Phase 1 BETA gate 80; path +2 pts trong 2-3 tuần) |
...
| **Security baseline** | security-audit skill /100 + **v2 audit format mandatory per GAP-564** (per-control evidence block: Command run + Output + Verdict + Evidence artifact ID — see `.claude/skills/quality/security-audit/reference/audit-report-template-v2.md`) | Post-wave + quarterly | Auditor | ✅ REFRESHED (2026-05-15, **90/100 A-** — Wave 83 post-deploy, v2 format; +1 vs Wave 78 baseline 89; A05 stacktrace leak hardening + A09 PDPL Art 11 opt-in shipped; v2 evidence 9/9 blocks; PASS Phase 1 BETA ≥80; 3 P1 Wave 78 carry-forward unchanged) |
