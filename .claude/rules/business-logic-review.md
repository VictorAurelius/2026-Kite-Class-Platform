...
| **Competitor analysis** | "Hotmart 7-day trial; KiteClass goes 14d to differentiate" | Name the competitor + cite the public source |
...
International compliance (GDPR, CCPA) is out of scope until KiteClass expands beyond Vietnam — flag in `documents/00-brd/compliance-scope.md` (GAP-150 deliverable).
...
- **Code reference:** `kitehub-subscription/src/main/java/com/kite/hub/subscription/config/TrialConfig.java`
...
- **Value:** 36 months after account deletion (config key: `kitehub.privacy.retention-months`)
