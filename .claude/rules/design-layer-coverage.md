...
### 2.2 Per-kit (e.g. `ui_kits/kiteclass-pro-v2/`)
...
**Scenario:** Filing GAP-266 (Track 2 port — kiteclass-pro v2 → production Next.js) at 2026-04-29.

**Apply §2.1 matrix BEFORE filing:**

| Layer | Required pointer | Status at GAP-266 filing | Verdict |
|-------|-----------------|--------------------------|---------|
| 要件定義 | Persona + use case + business rule | ✅ `dossier/01-personas.md` P2 Center Owner + `documents/01-business/kiteclass/*/use-cases.md` | OK |
| 基本設計 | Screen mockup + flow + AC | ✅ `ui_kits/kiteclass-pro-v2/screens/*.html` (10 screens) + `dossier/03-screen-inventory.md` | OK |
...
**Apply §2.2 matrix to kit `ui_kits/kiteclass-pro-v2/`:**
