...
grep -rnE "@(Post|Put|Patch|Delete|Get)Mapping" kitehub/*/src/main/java/**/*AdminController.java \
...
Verify:
```bash
grep -A2 "management.endpoints.web.exposure" kitehub/*/src/main/resources/application-production.yml
