...
- **Tables:** for STRUCTURAL comparison only (e.g. KiteHub vs KiteClass roles). NEVER for score / state tables (those drift).
...
| README | Content rule |
|--------|--------------|
| `kitehub/README.md` / `kiteclass/README.md` | Service-level setup + scripts (versions OK; service-specific) |
