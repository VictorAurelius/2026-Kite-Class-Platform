...
| `service` | String, kebab-case, matches container name | App config | `kitehub-subscription` |
...
Planned location after GAP-114: `kitehub/kitehub-shared/src/main/resources/logback-base.xml` (extended per-service via `spring.profiles.active`).
