...
│  → Document inline trong PR closure: "Entry [N] reserved for <chapter Y> Wave Z"
│
...
Project đã từng làm bulk renumber: Wave 102.7.6 dropped Anthropic Claude [15] + 9 orphan refs (per bibliography.md header). Tham khảo `cross-ref-audit-2026-05-19.md` cho process precedent + `renumber_citations.py` (legacy Python helper trong `documents/08-thesis/`).
...
- `documents/08-thesis/references/cross-ref-audit-2026-05-19.md` — Wave 102.4 manual audit precedent + Round 3 ship verdict
- `documents/08-thesis/renumber_citations.py` — Python helper cho bulk renumber
