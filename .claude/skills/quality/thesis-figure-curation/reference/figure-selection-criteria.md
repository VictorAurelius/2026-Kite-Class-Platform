...
- [ ] **VN-friendly sample data** (per `vn-localization-audit-checklist.md` §3) — `Trần Thị Hồng`, `Trung tâm Sky Education`, KHÔNG `John Doe`
...
[paragraph -1] "Hình 2.3 minh hoạ kiến trúc đa tenant của KiteHub."  ← citation here
[FIGURE 2.3 Mermaid block]
[CAPTION: **Hình 2.3: Kiến trúc đa tenant KiteHub**]
...
| Sample data `John Doe / Test Center` | `Trần Thị Hồng / Trung tâm Sky Education` |
