...
2. **Group by priority:** P0 (blockers) → P1 (important) → P2 (nice-to-have) → P3 (opportunistic)
3. **Group by domain:** Frontend / Backend / DevOps / Docs / Architecture
4. **Dependency check:** gap nào block gap khác? (tìm "Related" links, shared domain)
5. **Score:** Impact (5=blocks prod, 3=blocks feature, 1=inconvenience) ÷ Effort (1=<2h, 3=half-day, 5=multi-day)
6. **Suggest sprint assignment** — gom P0 vào sprint hiện tại, P1 independent có thể parallel, P2 batch theo domain
7. **Update** `documents/04-quality/gaps/ROADMAP.md` với assignments
